...
class Organizer():
    ...
    def honest_node_label_defense(self, logger, adaptive=False, record_process=True, record_model=False, plot=False):
            ...
            for j in range(MAX_EPOCH):
                ...
                for i in range(NUMBER_OF_PARTICIPANTS):
                    ...
                    if i == 0:
                        ...
                        honest_node_side, correct_set = participants[i].normal_detection(i)
...
org = Organizer()
org.set_random_seed()
org.honest_node_label_defense(logger)